...
def caesar(original, codeword):
    ...
    for idx in range(len(codeword)):
        if ((ord(codeword[idx]) - ord(original[idx])) != shift) and ((26 - math.fabs(ord(codeword[idx]) - ord(original[idx]))) != shift):
            return -1
       
    return shift

def test():
     print( "test_caesar: ", end=": " )
     print( caesar( "very", "ajwd") == 5, end=" " )
     print( caesar( "nihal", "snmfq") == 5, end=" " )
     print( caesar( "very", "oxkr") == 19, end=" " )
     print( caesar ("nihal", "gbate" ) == 19, end=" " )
     print( caesar ("nihal", "asdff" ) == 7, end=" " )
     print( caesar ("ayzb", "fdeg" ) == 5 , end=" " )
     print( "." )
