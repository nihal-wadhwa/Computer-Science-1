    ...
    for idx1 in range(len(string1)-1):
        ...
        for idx2 in range(len(string2)-1):
            ...
            if string1[idx1] == string2[idx2]:
                ...
                while True:
                    if (idx1 + this_match_count > len(string1) - 1) or (idx2 + this_match_count > len(string2)-1):
                        break
                    else:
                        if string1[idx1 + this_match_count]== string2[idx2+this_match_count]:
                            this_match_count = this_match_count + 1
                        else:
                            break
...
def test():
    print( "test_match: ", end=": " )
    print(match("established", "ballistic") == 3, end=" ")
    print(match("alter", "ballistic")== 2, end =" ")
    print(match("tall", "tall")==4, end = " ")
    print(match("fall", "asdlkfjhasdkjlhfallaskdjfasd") == 4, end = " ")
    print(match("asdlkfjhasdkjlhfallaskdjfasd", "fall") == 4, end = " ")
    print(match("asdlkfjhasdkjlhfallaskdjfasd", "lal") == 2, end = " ")
    print(match("lal", "asdlkfjhasdkjlhfallaskdjfasd")== 2, end  = " ")
    print(match("tall", "tall")==0, end = " ")
    print(match("established", "ballistic") == 5, end=" ")
    print(match("asdlkfjhasdkjlhfallaskdjfasd", "lal") == 5, end = " ")
    print( "." )
